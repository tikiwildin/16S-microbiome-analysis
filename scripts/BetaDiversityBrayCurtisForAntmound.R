# Script: BetaDiversityBrayCurtisForAntmound.R
# Project: 16S rRNA Microbiome Analysis
# Purpose: This script reads a mothur-generated Bray-Curtis distance matrix
#          for ant mound microbiome samples and performs Principal Coordinates
#          Analysis (PCoA)
# Input:
#   - braycurtis.0.03.lt distance matrix file generated by mothur
# Output:
#   - Bray-Curtis PCoA plot displayed in R
# Author: Atiq Bacus
